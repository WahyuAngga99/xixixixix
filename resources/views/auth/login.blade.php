        ...
        @enderror
          ...
          <div class="text-center lg:text-left">
            ...
            <p class="mb-0 mt-2 pt-1 text-sm font-semibold">
              ...
              <a href="{{ route('register') }}" class="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">Register</a>
            </p>
          </div>
        </form>
      </div>
