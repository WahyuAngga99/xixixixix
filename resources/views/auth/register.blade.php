          ...
          <div
            ...
            <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                ...
                <div
                  ...
                  <p class="mb-0 mr-4 text-lg">Regristar in with</p>
                  <button
                    type="button"
                    data-te-ripple-init
              ...
              @enderror
                ...
                <div class="relative mb-6" data-te-input-wrapper-init>
                    <label for="image" class="block text-gray-700 font-bold mb-2">Choose Image</label>
                    <input type="file" name="image" id="image" accept="image/*" class="border border-gray-300 p-2 w-full">
